...
/**
 * @Author: [xiaorui.lu]
 * @CreateDate: [2014年8月13日 下午3:30:10]
 * @Version: [v1.0]
 * 
 */
public class SegmentTreeFunc<T extends Comparable<T>> {
	private int length;
	...
	public static void main(String[] args) {
		...
		System.out.format("%d ", t.get(2, 3));
		System.out.format("%d ", t.get(3, 4));
		System.out.format("%d ", t.get(4, 5));
		System.out.format("%d ", t.get(5, 6));
		System.out.format("%d ", t.get(6, 7));
		System.out.format("%d ", t.get(3, 6));
		System.out.println();
		t.set(11, 5, 6);
		System.out.format("%d ", t.get(5, 6));
//		System.out.format("%d ", t.get(0, 1));
