...
//		dlink.insert(0, 21); // 将 20 插入到第一个位置
//		dlink.insert(1, 22); // 将 20 插入到第一个位置
//		dlink.insert(2, 23); // 将 20 插入到第一个位置
//		dlink.appendLast(10); // 将 10 追加到链表末尾
//		dlink.insertFirst(30); // 将 30 插入到第一个位置
//		dlink.insertFirst(31); // 将 30 插入到第一个位置
//		dlink.insertFirst(32); // 将 30 插入到第一个位置
	...
	private static Student[] students = new Student[] { new Student(10, "sky"), new Student(20, "jody"), new Student(30, "vic"),
			new Student(40, "dan"), };
